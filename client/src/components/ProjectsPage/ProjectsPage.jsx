...
import { Eye, ExternalLink, ImageOff, Code2, Search, Filter } from "lucide-react";
    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <div className={styles.container}>
          ...
          <section
            ref={headerRef}
            className={`${styles.headerSection} ${headerVisible ? styles.visible : styles.reveal}`}
          >
          ...
          <section
            ref={gridRef}
            className={`${styles.projectsSection} ${gridVisible ? styles.visible : styles.reveal}`}
          >
            {loading ? (
              ...
              <>
                {/* Filters — visible whenever projects exist */}
                {projects.length > 0 && (
                  <div className={styles.filterBar}>
                    <div className={styles.filterTabs}>
                      {["all", "completed", "in progress", "planning"].map((s) => (
                        <button
                          key={s}
                ...
                {projects.length === 0 ? (
                  ...
                  <div className={styles.emptyState}>
                    ...
                    <p className={styles.emptyDescription}>
                      No projects match your current filter. Try adjusting your search or filter criteria.
                    </p>
                  </div>
                ) : (
                  <div className={styles.projectsGrid}>
                    {filteredProjects.map((project, i) => (
                      <div key={project.id} className={styles.projectCard} style={{ transitionDelay: `${i * 60}ms` }} onClick={() => handleProjectClick(project)}>
          ...
          {projects.length > 0 && (
            <section
              ref={statsRef}
              className={`${styles.statsSection} ${statsVisible ? styles.visible : styles.reveal}`}
            >
